...
import com.mascarpone.delivery.payload.modifier.ModifierNamePriceMaxCountResponse;
...
public class CreatedProductResponse {
    ...
    private List<ModifierNamePriceMaxCountResponse> modifiers;
    private Unit unit;
    ...
    public CreatedProductResponse(Product product) {
        ...
        List<ModifierNamePriceMaxCountResponse> modifierResponses = new ArrayList<>();
        List<Modifier> modifiers = product.getModifiers();

        for (Modifier modifier : modifiers) {
            modifierResponses.add(new ModifierNamePriceMaxCountResponse(modifier));
        }
